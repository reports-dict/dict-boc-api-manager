...
use App\Http\Middleware\JwtSessionGuest;
...
Route::middleware(JwtSessionGuest::class)->get('/', [DashboardController::class, 'index'])->name('dashboard');
...
Route::middleware(JwtSessionAuth::class)->group(function () {
    ...
    Route::get('/transmissions/{transmission}/download', [TransmissionController::class, 'download'])->name('transmissions.download');
